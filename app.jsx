        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <button
              ...
              className="ml-4 px-6 py-2 bg-[#3b82f6] text-white rounded-lg text-sm font-semibold hover:bg-blue-600 transition-all duration-200 shadow-lg shadow-blue-500/25"
            >
              Book a Session
            </button>
          </div>
          ...
          <div className="md:hidden pb-4 border-t border-white/10 pt-4">
            {['home', 'services', 'about', 'contact'].map((page) => (
              <button
                key={page}
                onClick={() => navigateTo(page)}
                className={`block w-full text-left px-4 py-3 rounded-lg text-sm font-medium capitalize transition-all duration-200 ${
                  currentPage === page
                    ? 'bg-[#3b82f6] text-white'
                    : 'text-gray-300 hover:text-white hover:bg-white/10'
                }`}
            ...
            <button
              onClick={() => navigateTo('contact')}
              className="mt-3 w-full px-6 py-3 bg-[#3b82f6] text-white rounded-lg text-sm font-semibold hover:bg-blue-600 transition-all duration-200"
            >
              Book a Session
            </button>
          </div>
